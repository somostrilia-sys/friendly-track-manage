...
const AcompanhamentoInstalacoes = () => {
  ...
  const [form, setForm] = useState({ placa: "", imei: "", chip: "", filial: "", tecnico_id: "" as string | null, data: "" });
  ...
  const concluir = async (id: string) => {
    ...
    try {
      await updateInstalacao.mutateAsync({ id, status: "concluida", localizacao_confirmacao: loc || "" });
  ...
  const salvar = async () => {
    ...
    try {
      ...
      setModalOpen(false);
      setForm({ placa: "", imei: "", chip: "", filial: "", tecnico_id: "", data: "" });

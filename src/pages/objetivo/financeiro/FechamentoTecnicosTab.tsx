...
const FechamentoTecnicosTab = () => {
  ...
  const salvar = () => {
    if (!form.tecnicoId || !form.periodo) { toast.error("Preencha tecnico e periodo"); return; }
            ...
            <>
              ...
              <div className="mt-6 space-y-5 text-sm">
                <div className="grid grid-cols-2 gap-3">
                  <div><span className="text-muted-foreground">Tecnico</span><p className="font-medium">{detalhe.tecnicoNome}</p></div>
